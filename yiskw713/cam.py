...
class CAM(object):
    ...
    def forward(self, x, idx=None):
        ...
        cam.data = F.interpolate(cam.data, size=(h, w), mode='bilinear', align_corners=False)
...
class SmoothGradCAMpp(CAM):
    ...
    def forward(self, x, idx=None):
        ...
        if idx==None:
            ...
            print("predicted class ids {}\t probability {}".format(idx, prob))
        _,_,h,w=x.shape
        total_cams.data = F.interpolate(total_cams.data, size=(h, w), mode='bilinear', align_corners=False)
